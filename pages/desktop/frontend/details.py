...
class Detail(Base):
    ...
    class Stats(Region):
        ...
        def addon_reviews_stats(self):
            self.wait.until(EC.visibility_of_element_located(self._stats_reviews_locator))
        ...
        def addon_star_rating_stats(self):
            self.wait.until(EC.visibility_of_element_located(self._stats_ratings_locator))
            return self.find_element(*self._stats_ratings_locator)

        @property
        def rating_score_tile(self):
            self.wait.until(EC.visibility_of_element_located(self._rating_score_title_locator))
        ...
        def rating_title(self):
            self.wait.until(EC.visibility_of_element_located(self._rating_title_locator))
        ...
        def bar_grouped_ratings(self):
            self.wait.until(EC.visibility_of_element_located(self._grouped_ratings_locator))
        ...
        def bar_rating_counts(self):
            self.wait.until(EC.visibility_of_element_located(self._rating_bar_count_locator))
    ...
    class Contribute(Region):
        ...
        def contribute_card_header(self):
            self.wait.until(EC.visibility_of_element_located(self._contribute_header_locator))
        ...
        def contribute_button_text(self):
            self.wait.until(EC.visibility_of_element_located(self._contribute_button_locator))
            return self.find_element(*self._contribute_button_locator).text

        @property
        def contribute_button_heart_icon(self):
            self.wait.until(EC.visibility_of_element_located(self._contribute_button_icon_locator))
    ...
    class Permissions(Region):
        ...
        def permissions_card_header(self):
            self.wait.until(EC.visibility_of_element_located(self._permissions_header_locator))
            return self.find_element(*self._permissions_header_locator).text

        @property
        def permissions_list(self):
            self.wait.until(EC.visibility_of_element_located(self._permissions_list_locator))
        ...
        def permissions_learn_more_button(self):
            self.wait.until(EC.visibility_of_element_located(self._permissions_learn_more_locator))
            return self.find_element(*self._permissions_learn_more_locator).text

        @property
        def permissions_learn_more_button_icon(self):
            self.wait.until(EC.visibility_of_element_located(self._learn_more_button_icon_locator))
            return self.find_element(*self._learn_more_button_icon_locator)

        def click_permissions_button(self):
            self.wait.until(EC.element_to_be_clickable(self._permissions_learn_more_locator))
        ...
        class PermissionDetails(Region):
            ...
            def permission_icon(self):
                self.wait.until(EC.visibility_of_element_located(self._permission_icon_locator))
                return self.find_element(*self._permission_icon_locator)

            @property
            def permission_description(self):
                self.wait.until(EC.visibility_of_element_located(self._permission_description_locator))
    ...
    class MoreInfo(Region):
        ...
        def more_info_card_header(self):
            self.wait.until(EC.visibility_of_element_located(self._more_info_header_locator))
            return self.find_element(*self._more_info_header_locator).text

        @property
        def addon_support_links(self):
            self.wait.until(EC.visibility_of_element_located(self._support_links_locator))
            return self.find_elements(*self._support_links_locator)

        @property
        def addon_homepage_link(self):
            self.wait.until(EC.visibility_of_element_located(self._homepage_link_locator))
            return self.find_element(*self._homepage_link_locator)

        @property
        def addon_support_site_link(self):
            self.wait.until(EC.visibility_of_element_located(self._support_site_link_locator))
        ...
        def addon_last_update_date(self):
            self.wait.until(EC.visibility_of_element_located(self._last_updated_locator))
            return self.find_element(*self._last_updated_locator)

        @property
        def addon_categories(self):
            self.wait.until(EC.visibility_of_element_located(self._addon_categories_locator))
            return self.find_elements(*self._addon_categories_locator)

        @property
        def addon_external_license_text(self):
            self.wait.until(EC.visibility_of_element_located(self._addon_license_locator))
            return self.find_element(*self._addon_license_locator).text

        @property
        def addon_all_rights_reserved_license_text(self):
            self.wait.until(EC.visibility_of_element_located(self._all_rights_reserved_license_locator))
        ...
        def addon_versions(self):
            self.wait.until(EC.visibility_of_element_located(self._all_versions_locator))
        ...
        class License(Region):
            ...
            def custom_licence_and_privacy_header(self):
                self.wait.until(EC.visibility_of_element_located(self._license_and_privacy_header_locator))
                return self.find_element(*self._license_and_privacy_header_locator).text

            @property
            def custom_licence_and_privacy_text(self):
                self.wait.until(EC.visibility_of_element_located(self._license_and_privacy_text_locator))
                return self.find_element(*self._license_and_privacy_text_locator)

            @property
            def custom_licence_and_privacy_summary_card(self):
                self.wait.until(EC.visibility_of_element_located(self._addon_summary_card_locator))
    ...
    class Screenshots(Region):
        ...
        def screenshot_section_header(self):
            self.wait.until(EC.visibility_of_element_located(self._screenshot_section_header_locator))
            return self.find_element(*self._screenshot_section_header_locator)

        @property
        def screenshot_preview(self):
            self.wait.until(EC.visibility_of_element_located(self._screenshot_thumbnail_locator))
            return self.find_elements(*self._screenshot_thumbnail_locator)

        @property
        def screenshot_viewer(self):
            self.wait.until(EC.visibility_of_element_located(self._screenshot_viewer_locator))
        ...
        def screenshot_counter(self):
            self.wait.until(EC.visibility_of_element_located(self._screenshot_counter_location))
            return self.find_element(*self._screenshot_counter_location).text

        def close_screenshot_view(self):
            self.wait.until(EC.element_to_be_clickable(self._image_view_close_button_locator))
    ...
    class ReleaseNotes(Region):
        ...
        def release_notes_header(self):
            self.wait.until(EC.visibility_of_element_located(self._release_notes_card_header_locator))
            return self.find_element(*self._release_notes_card_header_locator).text

        @property
        def release_notes_text(self):
            self.wait.until(EC.visibility_of_element_located(self._release_notes_content_locator))
    ...
    class AddonsByAuthor(Region):
        ...
        def addons_by_author_header(self):
            self.wait.until(EC.visibility_of_element_located(self._addons_by_author_header_locator))
            return self.find_element(*self._addons_by_author_header_locator).text

        @property
        def addons_by_author_results_list(self):
            self.wait.until(EC.visibility_of_element_located(self._addons_by_author_results_locator))
            return self.find_elements(*self._addons_by_author_results_locator)

        @property
        def addons_by_author_results_items(self):
            self.wait.until(EC.visibility_of_element_located(self._addons_by_author_results_item_locator))
    ...
    class AddToCollection(Region):
        ...
        def collections_card_header(self):
            self.wait.until(EC.visibility_of_element_located(self._collection_card_header_locator))
            return self.find_element(*self._collection_card_header_locator).text

        @property
        def collections_select_field(self):
            self.wait.until(EC.visibility_of_element_located(self._collection_select_locator))
            return self.find_element(*self._collection_select_locator)

        @property
        def add_to_collections_list(self):
            self.wait.until(EC.visibility_of_element_located(self._select_collections_list_locator))
    ...
    class AddonDescription(Region):
        ...
        def addon_description_header(self):
            self.wait.until(EC.visibility_of_element_located(self._description_header_locator))
            return self.find_element(*self._description_header_locator).text

        @property
        def addon_description_text(self):
            self.wait.until(EC.visibility_of_element_located(self._description_text_locator))
    ...
    class AddonRecommendations(Region):
        ...
        def addon_recommendations_header(self):
            self.wait.until(EC.visibility_of_element_located(self._recommendations_card_header_locator))
            return self.find_element(*self._recommendations_card_header_locator).text

        @property
        def addons_recommendations_results_list(self):
            self.wait.until(EC.visibility_of_element_located(self._recommendations_card_results_locator))
            return self.find_elements(*self._recommendations_card_results_locator)

        @property
        def recommendations_results_item(self):
            self.wait.until(EC.visibility_of_element_located(self._recommendations_name_locator))
    ...
    class Ratings(Region):
        ...
        def submit_review_error(self):
            self.wait.until(EC.visibility_of_element_located(self._submit_review_error_locator))
        ...
        def ratings_card_header(self):
            self.wait.until(EC.visibility_of_element_located(self._ratings_card_header_locator))
            return self.find_element(*self._ratings_card_header_locator).text

        @property
        def ratings_card_summary(self):
            self.wait.until(EC.visibility_of_element_located(self._ratings_card_summary_locator))
            return self.find_element(*self._ratings_card_summary_locator).text

        @property
        def rating_login_button(self):
            self.wait.until(EC.visibility_of_element_located(self._login_to_rate_button_locator))
        ...
        def delete_confirm_button(self):
            self.wait.until(EC.visibility_of_element_located(self._delete_confirm_button_locator))
            return self.find_element(*self._delete_confirm_button_locator)

        def click_delete_confirm_button(self):
            self.wait.until(EC.element_to_be_clickable(self._delete_confirm_button_locator))
        ...
        def write_a_review(self):
            self.wait.until(EC.visibility_of_element_located(self._write_review_button_locator))
        ...
        def review_text_input(self, value):
            self.wait.until(EC.visibility_of_element_located(self._review_textarea_locator))
        ...
        def submit_review_button(self):
            self.wait.until(EC.visibility_of_element_located(self._submit_review_button_locator))
            return self.find_element(*self._submit_review_button_locator)

        def submit_review(self):
            self.wait.until(EC.element_to_be_clickable(self._submit_review_button_locator))
        ...
        def cancel_review(self):
            self.wait.until(EC.visibility_of_element_located(self._cancel_review_write_locator))
        ...
        def keep_review_button(self):
            self.wait.until(EC.visibility_of_element_located(self._keep_review_button_locator))
        ...
        def all_reviews_link(self):
            self.wait.until(EC.visibility_of_element_located(self._all_reviews_link_locator))
        ...
        def report_abuse_button(self):
            self.wait.until(EC.visibility_of_element_located(self._report_abuse_button_locator))
            return self.find_element(*self._report_abuse_button_locator)

        def click_report_abuse(self):
            self.wait.until(EC.element_to_be_clickable(self._report_abuse_button_locator))
