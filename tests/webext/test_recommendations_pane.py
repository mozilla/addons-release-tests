...
def test_install_addon_from_recommendations_pane_TC_ID_C617016(selenium, base_url, firefox, firefox_notifications, variables, wait):
    ...
    wait.until(
        about_addons.addon_cards_items[1].manage_addon_button.is_displayed()
    )
    assert about_addons.addon_cards_items[1].manage_addon_button.is_displayed()
    about_addons.addon_cards_items[1].manage_addon_button.click()
